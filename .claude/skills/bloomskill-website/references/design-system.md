...
- **The 4D motif:** Define/Design/Develop/Deliver each get a numbered marker (01–04) in the accent color with a thin connecting line — a horizontal stepper on desktop, vertical timeline on mobile. This motif repeats on home, services, and inside every case study (highlighting which Ds were used).
