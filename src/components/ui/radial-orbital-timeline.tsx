  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  text-[0.65rem] font-semibold tracking-wider
        ...
        {/* Expanded detail card — anchored to the stage so it never overflows */}
        {activeItem && (
          <Card className="absolute z-[300] left-1/2 bottom-3 -translate-x-1/2 w-60 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-px h-3 bg-white/50"></div>
            <CardHeader className="pb-2 p-4">
              <div className="flex justify-between items-center">
                <Badge
                  className={`px-2 text-[0.6rem] ${getStatusStyles(activeItem.status)}`}
                >
              ...
              {activeItem.relatedIds.length > 0 && (
                <div className="mt-4 pt-3 border-t border-white/10">
                  <div className="flex items-center mb-2">
                    ...
                    <h4 className="text-[0.6rem] uppercase tracking-wider font-medium text-white/70">
                      Connected
                    </h4>
                  </div>
